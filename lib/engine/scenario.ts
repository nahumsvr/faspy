...
/** Liquidación fija del escenario acordado; no generaliza reglas a otras facturas. */
export function paymentFor(facturaId: string): ResultadoPago | undefined {
  return facturaId === agreedScenario.response.factura_id ? { ...agreedScenario.payment } : undefined;
}
